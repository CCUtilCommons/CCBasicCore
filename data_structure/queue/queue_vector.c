...
static const char* _wrongoverride_vector_message = "Wrong Impl Error happens in CCVector Queue";
...
static void _pushVectorPtr(
	...
	if (__CCBasicCoreVector_PushBack(vector, elem, size) != CCBasicCore_SUCCESS) {
